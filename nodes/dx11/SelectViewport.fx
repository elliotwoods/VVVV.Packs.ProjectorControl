//@author: elliotwoods
//@help: standard constant shader with viewport selection
//@tags: color
//@credits: vux 
...
vs2ps VS(VS_IN input)
{
	...
	Out.PosWVP *= ViewPortSelected();
    return Out;
}

vs2ps VSWithinViewport(VS_IN input)
{
    vs2ps Out = (vs2ps)0;
...
technique10 ConstantWithinViewport
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_4_0, VSWithinViewport() ) );
		SetPixelShader( CompileShader( ps_4_0, PS() ) );
	}
}
